...
│   └── 3_prediction.py
│
├── tests/                         # testes automatizados unitáios e de integração
│    ├── unit/
│    |  ├── test_artifacts.py
│    |  └── test_cluster.py
│    └── integration/
...
|
└── .github/                       # automação de CI/CD co GitHub Actions
    └── workflows/
        └── ci.yml                 # worflow para instalação e dependências dos testes
...
b. Acesse https://streamlit.io/cloud  
c. Conecte sua conta ao GitHub  
d. Selecione este repositório  
e. Defina o arquivo principal:
